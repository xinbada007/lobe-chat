...
<Steps>
  ...
  - Open **App Settings → AI Providers**, select **Azure OpenAI**, and enable the provider

  <Image alt={'Enter your API key'} inStep src={'/blog/assets17870709/63d9f6d4-5b78-4c65-8cd1-ff8b7f143406.webp'} />

  - Enter the API key and endpoint. The model ID must match the deployment name you created in Azure
  - Select **Check** to test the connection, then enable or add the deployed model in the model list
