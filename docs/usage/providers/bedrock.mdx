...
<Steps>
  ...
  - Open **App Settings → AI Providers**, select **Amazon Bedrock**, and enable the provider
  ...
  - Choose an authentication method. You can enter a Bedrock API key, or enter an Access Key ID and Secret Access Key with an optional session token
  - Select the AWS region, then select **Check** to test the connection
  - Enable the Amazon Bedrock models you need, then select one in the Agent settings
