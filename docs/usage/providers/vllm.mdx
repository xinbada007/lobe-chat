...
<Steps>
  ...
  - Open **App Settings → AI Providers**, select **vLLM**, and enable the provider

  <Image alt={'Enter vLLM API Key'} inStep src={'/blog/assets02dce7325584974cdba327fe2f996b9e.webp'} />

  - Enter the vLLM server URL. If the server requires API key authentication, enter the API key
  ...
  - Select **Check** to test the connection, then fetch or add the running model in the model list
