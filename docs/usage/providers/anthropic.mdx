...
<Steps>
  ...
  - Open **App Settings → AI Providers**, select **Anthropic**, and enable the provider
  - Enter the API key. If you use a proxy, enter its proxy URL
  ...
  - Enable the Claude models you need, then select one in the Agent settings
