...
<Steps>
  ...
  - Open **App Settings → AI Providers**
...
Vercel AI Gateway connects to models from multiple providers. Available models and model IDs change with the gateway catalog. Fetch or add current models from the model list in LobeHub.
