...
<Steps>
  ...
  - Open **App Settings → AI Providers**, select **Aliyun Bailian**, and enable the provider.
  - Enter the DashScope API key. If you use a compatible endpoint, enter its proxy URL.
  ...
  - Enable the Qwen models you need, then select one in the Agent settings.
