...
description: >-
  Learn how to configure an OpenAI API key, proxy URL, model list, and connection check in LobeHub.
tags:
  - ChatGPT
  - GPT-6 Astra
  - API Key
...
'https://github-production-user-asset-6210df.s3.amazonaws.com/28616219/296255167-f2745f2b-f083-4ba8-bc78-9b558e0002de.png'
  ...
  - Open **App Settings → AI Providers**, select **OpenAI**, and enable the provider
  - Enter the API key. If you use a proxy or compatible endpoint, enter its proxy URL

  <Image alt={'Enter your API key'} inStep src={'/blog/assets17870709/3f31bc33-509f-4ad2-ba81-280c2a6ec5fa.webp'} />

  - Select **Check** to test the connection
  - Enable the OpenAI models you need, then select one in the Agent settings
