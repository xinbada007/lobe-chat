...
In LobeHub chat, you can edit messages, view formatted content, and branch a conversation to explore a different direction while keeping the original discussion.

## Core Chat Features

On desktop and mobile, the chat interface includes:
...
Conversation branching lets you explore several approaches from the same message.
...
<AccordionGroup>
  ...
  <Accordion title="Don't Over-Branch">
    Start with 2–4 key alternatives to make branches easier to compare.
  </Accordion>
...
- **Archive** — Organize your conversation list without deleting valuable conversations
