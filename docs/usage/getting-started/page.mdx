...
Use Pages to write technical docs, study notes, project proposals, or blog posts with Markdown, real-time preview, and auto-save. You can ask an Agent to edit the document directly, refine its structure, add paragraphs, or polish the wording.

## Pages and Other Document Types

Pages are independent writing documents. Agent Documents hold notes, reports, and reusable material that an Agent creates. These documents can also link to the current topic. Uploaded source files belong to the Resource Library. See the [storage comparison](/docs/usage/agent/agent-documents#choose-where-to-save-content).

## Why Use Pages?

Pages keep your document and writing tools together:

- **Persistent writing space** — Each document exists independently, saved permanently, ready to continue anytime
...
**Iterate in sections** — You can have the Agent draft one section, review and refine it together, then move to the next.

**Reuse templates** — Duplicate successful previous documents to reuse their structure.
...
- **Fact-checking** — Check AI-generated facts against their sources, especially statistics and technical claims
