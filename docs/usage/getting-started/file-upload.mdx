...
Upload documents, images, code, and other files so your Agents can read, analyze, and reference them in a conversation.
...
<Tabs>
  <Tab title="Documents">
    ...
    **You can:** Extract text, summarize documents, search content, and extract spreadsheet data.
  </Tab>
  ...
  <Tab title="Code & Data">
    ...
    **You can:** Review code, find bugs, generate documentation, and parse data. Code previews include syntax highlighting.
  </Tab>
  ...
  <Tab title="Images">
    ...
    **You can:** Analyze images with vision models, extract text (OCR), describe images, and ask for design feedback. See [Vision](/docs/usage/getting-started/vision) for details.
  </Tab>
  ...
  <Tab title="Media">
    ...
    **You can:** Play media, transcribe it with appropriate tools, and analyze its content.
  </Tab>
</Tabs>
