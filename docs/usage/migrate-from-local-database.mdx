...
- If you have multiple v1.x profiles, export each separately and import one at a time (when your v1.x build supports it).
...
- **Multiple profiles** — If you used multiple profiles in v1.x, export each separately and import one by one.
