export default {
  ...
  'ConversationParentMissing':
    'The conversation context for this message could not be found. Reopen the conversation or start a new topic, then send the request again.',
  ...
  'InvalidGithubCopilotToken':
    'GitHub Copilot authentication failed. Ask the bot or agent owner to refresh the GitHub Copilot credentials, then try again.',
  'InvalidGithubToken':
  ...
  'LobeHubModelDeprecated':
    'The selected model is no longer available. Ask the bot or agent owner to select an available model, then try again.',
